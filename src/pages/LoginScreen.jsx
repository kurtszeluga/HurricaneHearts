...
export default function LoginScreen({ message }) {
  ...
  const displayMessage = showSuccessSplash ? "" : message || storedMessage;

  useEffect(() => {
    if (!showSuccessSplash) return undefined;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-blue-50 flex items-center justify-center p-6">
        <motion.div
          ...
          className="bg-white rounded-3xl shadow-2xl p-10 max-w-md w-full text-center border border-green-200"
        >
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Your account request was submitted successfully and is pending administrator approval.
          </p>
      ...
      >
        ...
        <div className="grid gap-3">
          ...
          <button
            ...
            className={
              submittingAccess
                ? "w-full bg-gray-300 text-gray-500 py-4 rounded-2xl font-semibold transition cursor-not-allowed"
                : "w-full bg-red-600 hover:bg-red-700 text-white py-4 rounded-2xl font-semibold transition"
            }
          >
            {mode === "login" ? "Login with Email" : submittingAccess ? "Submitting..." : "Submit Email Access Request"}
          </button>
