      ...
      <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-blue-50 flex items-center justify-center p-6">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Your Hurricane Hearts access request was submitted successfully and is now waiting for administrator approval.
          </p>
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-blue-50 flex items-center justify-center p-6">
      ...
      >
        <div className="flex items-center gap-4 mb-6">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900 leading-tight">
              Hurricane He
              <span className="text-red-600">AR</span>
              ts
            </h1>
        ...
        <div className="flex gap-2 mb-5">
          <button
            onClick={clearFormAndReturnToLogin}
            className={
              mode === "login"
